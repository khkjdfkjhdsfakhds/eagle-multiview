...
contextBridge.exposeInMainWorld('eagleMV', {
  ...
  thumbnailOperation: data => ipcRenderer.invoke(data.operation === 'file' ? 'item:thumbnail-file' : data.operation === 'clipboard' ? 'item:thumbnail-clipboard' : 'item:thumbnail-operation', data),
  cancelThumbnailOperation: data => ipcRenderer.invoke('item:thumbnail-cancel', data),
  ...
  currentEagleWindowState: () => ipcRenderer.invoke('window:eagle-state'),
  ...
  moveFolder: data => ipcRenderer.invoke('folder:move', data),
  markFolderUsed: data => ipcRenderer.send('folder:used', data),
  importItems: data => ipcRenderer.invoke('items:import', data),
  startSiteImport: data => ipcRenderer.invoke('site:start', data),
  nextSiteImport: data => ipcRenderer.invoke('site:next', data),
  retrySiteImport: data => ipcRenderer.invoke('site:retry', data),
  cancelSiteImport: data => ipcRenderer.invoke('site:cancel', data),
  importSiteSelection: data => ipcRenderer.invoke('site:import', data),
  ...
  getManualOrders: data => ipcRenderer.invoke('manual-order:get', data),
  moveManualOrder: data => ipcRenderer.invoke('manual-order:move', data),
  ...
  putTextDraft: data => ipcRenderer.invoke('text-draft:put', data),
  getTextDraft: data => ipcRenderer.invoke('text-draft:get', data),
  listTextDrafts: data => ipcRenderer.invoke('text-draft:list', data),
  removeTextDraft: data => ipcRenderer.invoke('text-draft:remove', data),
